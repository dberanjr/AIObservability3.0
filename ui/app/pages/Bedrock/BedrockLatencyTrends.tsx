 ...
 * (min is thin and mostly sits at/near the baseline). Min/max start toggled
 * off in the legend — avg is the headline trend — but stay one legend click
 * away for anyone who wants the full band.
 */
const BandChart = ({
  bands,
  title,
